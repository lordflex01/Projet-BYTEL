      ...
      success: function (data, status) {
        ...
        var footer = $(
          "<tr><td></td>" +
            ...
            '<td  style="width: 40px"></td>' +
            '<td  style="width: 40px"></td>' +
            '<td style="width: 40px;color:red"></td></tr>'
        );
        $("#footTable").html("");
          ...
          for (let i = 0; i < nombreimputation; i++) {
            var LLL = $(
              "<tr><td></td><td><span>" +
                ...
                H[4 + j] +
                "></td>" +
                '<td><input type="text" min="0" max="1" step="0.25" class="form-control-imput" value=' +
                t[i] +
                "></td>" +
                '<td><input id="com' +
                i +
        ...
        $("#addRow").click(function () {
          ...
          scntDiv.append(
            '<tr><td></td><td><select class="form-control select2" id="codeP' +
              ...
              compteurligneajout +
              '" min="0" max="1" step="0.25" class="form-control-imput" value="0"></td>' +
              '<td><input type="text" id="totalSum" class="form-control-imput" ></td>' +
          ...
          $(document).on("click", ".form-control-imput", function () {
            ...
            var test = $("td:nth-child(10)", $tr).text(tot); // update last column value
