                ...
                if (bool2 == 1) {
                    ...
                    for (let i = 0; i < nombreimputation; i++) {
                        var LLL = $(
                            ...
                            "<tr><td></td>" + "<td><span>" + codprojettableau[i] + "</span></td>" + "<td><span>" + tacheteableau[i] + "</span></td>" + '<td><input id="m1' + imputID[i] + '" type="number" min="0" max="1" step="0.25" class="form-control-imput" value=' +
                            H[0 + j] +
